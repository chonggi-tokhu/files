/**
 * ! ColourgreyShorterJS v0.0.0 
 * () Colourgrey(chonggi-tokhu on github) 
 * https://github.com/chonggi-tokhu/files/tree/main/kin_choice/new/
*/
        ...
        var ColourgreyShorterJS = {
            ColourgreyShorterCSS: class extends ColourgreyShorterJSPR {
                ...
                tab = class {
                    /**
                     * 
                     * @param {HTMLElement | string} eltostyle 
                     * @param {boolean} options.onemustbeshown 
                     */
                ...
                popover = class {
                     ...
                     * @param {boolean} options.textpopover
                     * @param {HTMLElement|string} options.bodyEl
                     * @param {boolean} options.instantUsing
                     */
                    constructor(eltostyle, options) {
                        this.el = (typeof eltostyle == 'string') ? document.getElementById(eltostyle) : (eltostyle instanceof HTMLElement) ? eltostyle : null;
                        this.options = options;
                     ...
                     */
                    show(el, content) {
                        var newc = (typeof content === 'string') ? content : new String(content);
                        var newc2 = '';
                        var i43 = 0;
                ...
                dropDownList = class {
                     ...
                     */
                    constructor(eltostyle, options) {
                        this.el = (typeof eltostyle == 'string') ? document.getElementById(eltostyle) : (eltostyle instanceof HTMLElement) ? eltostyle : document.body;
                        this.options = options;
                ...
                folding_content = class {
                    /**
                     * 
                     * @param {string|HTMLElement} eltostyle 
                     * @param {object|undefined} options 
                     * @param {boolean} options.folded
                     */
                    constructor(eltostyle, options) {
                        ...
                        this.foldingEls.forEach(function (val, idx, arr) {
                            if (val.folded && !val.content.classList.contains("shown_folder_content")) {
                    ...
                    show_hide(folderidx) {
                        if (typeof folderidx === 'number' && parseInt(folderidx) == folderidx && checkObj(this.foldingEls[folderidx])) {
                            if (this.foldingEls[folderidx].control instanceof HTMLElement && this.foldingEls[folderidx].content instanceof HTMLElement && typeof this.foldingEls[folderidx].folded === 'boolean') {
                                if (this.foldingEls[folderidx].folded == true || !this.foldingEls[folderidx].content.classList.contains("shown_folder_content")) {
